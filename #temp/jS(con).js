...
Он позволяет обрабатывать результаты асинхронных операций так, как если бы они были синхронными:
	вместо конечного результата асинхронного метода возвращается своего рода обещание (дословный перевод слова "промис")
...
?? Цикл for in Для объектов (Для массивов незьзя)
	Для перебора всех свойств объекта используется цикл for..in.
		for (let key in user) {
...
?? Цикл for of								Для массивов (Для объектов нельзя)

*  ====================================================================================================//

Семь примитивных типов данных (числа, строки, булеан, null, undefinded, Simbol, bigint) и 1 ссылочный (объект)
...
Параметры - в скобках при объявлении
Аргументы - в скобках при вызове
...
Когда функция вызывается как метод объекта,используемое в этой функции ключевое слово this
	принимает значение объекта,по отношению к которому вызван метод. (Имеет значение только контекст вызова, а не контекст создания)
...
При пасширении класса к родителю обращаться через super
