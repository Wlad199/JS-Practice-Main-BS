...
! NPM ====================================================================================================//
https://habr.com/ru/companies/ruvds/articles/458504/
https://codedaddy.hashnode.dev/a-guide-to-npm-install-types-meanings-and-flags

npm install (npm i)										Установка пакетов
npm install <package-name>@<version>	Эта команда устанавливает определённую версию пакета.	Символ @ используется для указания номера версии.
...
По умолчанию для --save флага установлено значение true,
	поэтому его не обязательно указывать в более новых версиях NPM.
