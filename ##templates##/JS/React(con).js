...
2. Вывести на экран текст с переменными (09-10st)
			(I don't have any animals!!!
			My Wolf is 89 year old)`
	Менять текст с помощью свойства hasPet(true/false)

3. Создать кнопку, генерирующую число и вывести на экран (11st)
	Добавить возможность менять границы чисел через maxNum="300"

4. Создать 4 кнопки, увеличивающие счетчик (12st)
	Переделать кнопки с помощью map (13st)

5. Создать массив с помощью https://mockaroo.com/  (14st)
